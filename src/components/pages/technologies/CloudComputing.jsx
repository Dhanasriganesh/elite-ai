        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                <div className="bg-gradient-to-br from-blue-600 to-indigo-700 text-white px-4 py-6 md:px-6 md:py-8 rounded-lg sm:rounded-xl">
                  ...
                  <div className="text-xs sm:text-sm opacity-90">Cloud Migrations</div>
                </div>
                <div className="bg-gradient-to-br from-indigo-600 to-blue-700 text-white px-4 py-6 md:px-6 md:py-8 rounded-lg sm:rounded-xl">
                  ...
                  <div className="text-xs sm:text-sm opacity-90">Uptime SLA</div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl border border-blue-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 sm:hover:-translate-y-2">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-gray-800">Cloud Migration</h3>
              <p className="text-sm sm:text-base text-gray-600">Seamless migration of applications and data to cloud platforms with minimal downtime.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl border border-blue-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 sm:hover:-translate-y-2">
              ...
              <p className="text-sm sm:text-base text-gray-600">Enterprise-grade security with compliance frameworks like SOC 2, HIPAA, and GDPR.</p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 shadow-xl border border-blue-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 sm:hover:-translate-y-2">
              ...
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4 text-gray-800">Auto Scaling</h3>
              <p className="text-sm sm:text-base text-gray-600">Dynamic resource scaling to handle traffic spikes and optimize costs automatically.</p>
            </div>
          </div>
        </div>
      </section>
